...
import { applyReviewClientFilters } from '../src/parsers/review-client-filters.js';
import {
  placeAggregatesToRatingDistribution,
  sumRatingDistribution,
} from '../src/parsers/review-aggregates.js';
import type { PbNode } from '../src/types/protobuf.js';

const fixtureDir = join(import.meta.dirname, 'fixtures');

function loadBoqFixture(): PbNode {
  return JSON.parse(readFileSync(join(fixtureDir, 'boq-raw.json'), 'utf8')) as PbNode;
}
