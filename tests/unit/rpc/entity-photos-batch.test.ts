...
// fixtures under entity-photos-batch
...
describe('ListEntityPhotos batchexecute parser', () => {
  it('extracts continuation token from metadata-only first page', () => {
    const fixture = loadNestedJsonFixture('entity-photos-batch', 'page1-metadata.json') as { raw: unknown };
...
describe('CreateShortUrl batchexecute parser', () => {
  it('extracts maps.app.goo.gl link from live replay fixture', () => {
    const fixture = loadNestedJsonFixture('entity-photos-batch', 'create-short-url.json') as { raw: unknown };
