...
import { applyClientSearchFilters, isOpenNowStatus } from '../src/parsers/search-client-filters.js';
...
describe('search fixture carries open-status for client-side openNow', () => {
  it('parses open/closed from placeData[203]', () => {
    const raw = JSON.parse(readFileSync(join(fixtureDir, 'search-page1.json'), 'utf-8'));
