...
export class TransitService {
   ...
   */
  async getRoute(_options: TransitRouteOptions): Promise<TransitRouteResult> {
    throw new GMapsError(
      'Transit routing has no dedicated Maps service — use ' +
        "travel.directions.get({ origin, destination, mode: 'transit', includeSteps: true }), " +
        'which is backed by the working /maps/preview/directions surface.',
    );
  }
